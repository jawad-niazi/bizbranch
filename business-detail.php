      ...
      <div class="lg:col-span-8 space-y-8 fade-in-up delay-300">
        ...
        <section class="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="listing-card p-3 bg-white border border-slate-200 rounded-3xl shadow-sm hover:shadow-md transition">
              <!-- Top Image Block -->
              <div class="rounded-2xl overflow-hidden h-40 relative bg-slate-100">
                <img src="<?= htmlspecialchars($recent['image']) ?>" alt="<?= htmlspecialchars($recent['name']) ?>" class="w-full h-full object-cover">
                
                <div class="absolute top-2 left-2 bg-white/90 backdrop-blur-md px-2.5 py-1 rounded-xl text-[10px] font-extrabold text-blue-700 uppercase tracking-wider shadow-sm">
                  <?= htmlspecialchars($recent['category']) ?>
                </div>
                
                <div class="absolute top-2 right-2 bg-white/90 backdrop-blur-md px-2.5 py-1 rounded-xl text-[10px] font-extrabold text-slate-800 shadow-sm flex items-center">
                  ...
                  5.0 <span class="text-slate-500 ml-1 font-medium">(10)</span>
                </div>
              </div>
              ...
              <div class="p-3 space-y-3">
                <div>
                  <h3 class="font-extrabold text-sm text-slate-900 truncate"><?= htmlspecialchars($recent['name']) ?></h3>
                  <p class="text-xs text-slate-500 mt-1 flex items-center truncate">
                ...
                <a href="#" class="w-full bg-slate-900 hover:bg-blue-600 text-white font-bold py-2.5 rounded-xl text-xs transition text-center block">
                  View Details
                </a>
              </div>
            </div>
        ...
        <section class="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="listing-card p-3 bg-white border border-slate-200 rounded-3xl shadow-sm hover:shadow-md transition">
              <!-- Top Image Block -->
              <div class="rounded-2xl overflow-hidden h-40 relative bg-slate-100">
                <img src="<?= htmlspecialchars($similar['image']) ?>" alt="<?= htmlspecialchars($similar['name']) ?>" class="w-full h-full object-cover">
                
                <div class="absolute top-2 left-2 bg-white/90 backdrop-blur-md px-2.5 py-1 rounded-xl text-[10px] font-extrabold text-blue-700 uppercase tracking-wider shadow-sm">
                  <?= htmlspecialchars($similar['category']) ?>
                </div>
              ...
              <div class="p-3 space-y-3">
                <div>
                  <h3 class="font-extrabold text-sm text-slate-900 truncate"><?= htmlspecialchars($similar['name']) ?></h3>
                  <p class="text-xs text-slate-500 mt-1 flex items-center truncate">
                    <svg class="w-3.5 h-3.5 mr-1 text-slate-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path></svg>
                    United States
                  </p>
